...
<html>
    <head>
        ...
        <link href="../stylesheets/style_customer_care.css" rel="stylesheet" />
    </head>
    <body>
        <div class="container" data-stellar-background-ratio="0.3">
            ...
            <div class="body1">
                ...
                <div class="b2">
                    You can Mail to us at : yourcart_support@yourcart.com
                    <br />
                    <br />
                    For Urgent Support You can Call us on our Toll Free number
                    <br />
                    1800-555-1234
                    <br />
                    <br />
                    Our Damaged Product Hotline : 1800-555-1111
                </div>
            </div>
            <div class="footer">
                <div class="footer1">
