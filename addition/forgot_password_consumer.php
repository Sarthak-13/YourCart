<?php
    ...
    if(isset($_POST['btn_submit']))
    {
        ...
        $sql="select * from consumer_acc where email='".$a."' and phone='".$b."'";
        ...
        if($count>0)
        {
            ...
            else
            {
                ...
                $str=$str+1;
                $str=floor($str);
                $_SESSION['consumer_email']=$a;
                $sql1="update consumer_acc set password='".$str."' where email='".$a."' and phone='".$b."'";
                $rs=mysqli_query($con,$sql1);
                echo "<script>alert ('Password has been Changed');</script>";
                $_SESSION['con_pass_change']=1;
