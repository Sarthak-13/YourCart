<?php
    ...
    if($_SESSION['sub_cate_value']==null)
    {
    ...
    if($_SESSION['sub_sub_cate_value']!=null)
    {
        $c=$_SESSION['sub_sub_cate_value'];
        $sql="select * from products where sub_sub_cate='".$c."'";
...
<html>
    <head>
        ...
        <link href="../stylesheets/style_sub_cate.css" rel="stylesheet" />
    </head>
    <body>
            ...
            <div class="body1">
                ...
                <table cellpadding="2px" class="tab1">
                    <tr class="product_hori">
                        ...
                        <?php $i=0;}?>
                        <?php $i++;}while($result4=mysqli_fetch_assoc($rs1)) ?>
                    </tr>
                </table>
            </div>
            <div class="footer">
