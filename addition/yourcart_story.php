...
<html>
    <head>
        ...
        <link href="../stylesheets/yourcart_story_style.css" rel="stylesheet" />
    </head>
    <body>
        <div class="container">
            <div class="head">
            ...
            <div class="body1" id="body1" data-stellar-background-ratio="0.5">
                <div class="b1">
                    The YourCart Story
                </div>
            </div>
            <div class="body2" id="body2" data-stellar-background-ratio="0.5">
                <div class="b2">
                    <br />
                    <br />
                    Once Upon a time
            ...
            <div class="body3" id="body2" data-stellar-background-ratio="0.5">
                <div class="b3">
                    <br />
                    <br />
                    <br />
                    Who attended an intersting Training
                    <br />
                    session in their college about
                    <br />
                    Developing Websites
                </div>
            </div>
            <div class="body4" id="body2" data-stellar-background-ratio="0.5">
                <div class="b4">
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                    that if they could do it
                </div>
            </div>
            <div class="body5" id="body2" data-stellar-background-ratio="0.5">
                <div class="b5">
                    <br />
                    <br />
                    <br />
                    Inspired by a qoute by Steve Jobs :
                    <br />
                    "If you're Crazy enough to change the
                    <br />
                    ...
                    <br />
                    "If you're Curious enough to change the
                    <br />
                    then you can change the world"
                </div>
            </div>
            <div class="body6" id="body2" data-stellar-background-ratio="0.5">
                <div class="b6">
                    <br />
                    <br />
                    They had an Idea
            ...
            <div class="body7" id="body2" data-stellar-background-ratio="0.5">
                <div class="b7">
                    <br />
                    <br />
            ...
            <div class="body8" id="body2" data-stellar-background-ratio="0.5">
                <div class="b8">
                    <br />
                    <br />
                    If You're Curious Enough to
                    <br />
                    Change the world
                    <br />
                    Then You can Change the World
